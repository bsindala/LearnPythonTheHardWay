...
class CentralCorridor(Scene):
    def enter(self):
        ...
        if action == "shoot!":
            ...
            print "Lbhe zbgure vf fb sng, jura nebhaq gur ubhfr, fur fvgf nebhaq gur ubhfr."
...
class LaserWeaponArmory(Scene):
    def enter(self):
        ...
        print "You stand and run to the far side of the room and find the"
        ...
        if guess == code:
            ...
            print "bridge where you muct place it in the right spot."
            return 'the_bridge'
        else:
...
class TheBridge(Scene):
    def enter(self):
        print "You burst onto the Bridge with the neautron destruct bomb"
...
class EscapePod(Scene):
    def enter(self):
        ...
        if int(guess) != good_pod:
            ...
            print "inot jam jelly."
            return 'death'
        else:
            print "You jump into pod %s and hit the eject button." % guess
            print "The pod easily slides out inot space heading to"
